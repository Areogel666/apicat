...
use commands::{
    ...
    send_request::{get_history_record, list_history, send_request, open_response_file, export_response_file, cleanup_history},
    test_case::{
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            send_request, list_history, get_history_record, open_response_file, export_response_file, cleanup_history,
